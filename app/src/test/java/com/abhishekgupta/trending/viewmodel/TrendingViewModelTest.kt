...
class TrendingViewModelTest {
    ...
    @Test
    fun `test success with valid response`() {
        ...
        every { repositoryImpl.getTrendingRepositories() }.returns(Single.just(listOf(repositoryDto)))
    ...
    @Test
    fun `test success with invalid response`() {
